<section class="hero-section d-flex align-items-center justify-content-center py-6 position-relative" style="min-height: 70vh; background: linear-gradient(120deg, #232946 0%, #6366F1 100%); color: #fff;  margin-top: 50px;">
  <div class="container text-center">
    <h1 class="display-4 fw-bold mb-4">Dijital Dönüşümde Gücünüz NarSoft</h1>
    <p class="lead mb-5">Yenilikçi yazılım çözümleriyle işinizi geleceğe taşıyın.</p>
    <div class="d-flex flex-column flex-sm-row justify-content-center gap-3 mb-4">
      <a href="/iletisim" class="btn btn-custom-light px-5 py-3 fw-bold shadow">Hemen Teklif Al</a>
      <a href="/hakkimizda" class="btn btn-outline-light px-5 py-3 fw-bold shadow-sm">Projelerimiz</a>
    </div>
    <div class="mt-4 text-white-50 small fw-semibold" style="letter-spacing: 1px;">
