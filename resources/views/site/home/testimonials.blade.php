  ...
  <div class="container">
    <div class="row mb-5">
      <div class="col-12 text-center">
        <h2 class="section-heading fw-bold" style="font-size:2.4rem; color:#232946; letter-spacing:-1px;">Müşteri Yorumları</h2>
        <div style="width:48px;height:3px;background:#6366F1;margin:14px auto 0;border-radius:2px;"></div>
      </div>
    </div>
